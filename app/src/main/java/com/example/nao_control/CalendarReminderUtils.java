...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "jiabin";
    private static String CALENDARS_ACCOUNT_NAME = "jiabin@ualberta.ca";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.jiabin";
    private static String CALENDARS_DISPLAY_NAME = "jiabin account";
